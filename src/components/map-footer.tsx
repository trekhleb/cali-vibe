    ...
    <>
      ...
      <LegalModal open={modal === "about"} onClose={() => setModal(null)} title="About CaliVibe">
        ...
        <ul className="mt-2 space-y-2 text-sm">
          ...
          <li><strong>Race/Ethnicity Breakdown</strong> &mdash; White, Hispanic/Latino, Black, Asian, and Other race/ethnicity percentages for all 58 counties and 697 cities/CDPs (Census ACS 2019&ndash;2023).</li>
          <li><strong>Age Distribution</strong> &mdash; Under 18, 18&ndash;34, 35&ndash;64, 65+, and median age for all 58 counties and 697 cities/CDPs (Census ACS 2019&ndash;2023).</li>
          <li><strong>Poverty Rate</strong> &mdash; Percentage of population below the poverty level for all 58 counties and 697 cities/CDPs (Census ACS 2019&ndash;2023).</li>
      ...
      <LegalModal open={modal === "sources"} onClose={() => setModal(null)} title="Data Sources">
        <ul className="space-y-3">
          ...
          <li>
            ...
            <br />
            <span className="text-gray-500">ACS 5-Year Estimates (2019–2023). Median Home Value (B25077), Median Gross Rent (B25064) &amp; Median Household Income (B19013) by county and city.</span>
          </li>
          <li>
            ...
            <a href="https://data.census.gov/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">US Census Bureau</a>
            <br />
            <span className="text-gray-500">ACS 5-Year Estimates (2019–2023). Table B15003 &mdash; Educational Attainment for Population 25+. Bachelor&rsquo;s+, HS+, Graduate+ by county and city.</span>
          </li>
          <li>
          ...
          <li>
            ...
            <br />
            <span className="text-gray-500">TIGER/Line Places, 2024. 697 places (482 cities + 215 CDPs).</span>
          </li>
          <li>
          ...
          <li>
            <strong>Transit Data (SPRINTER)</strong>
            <br />
            <a href="https://gonctd.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">NCTD GTFS</a>
            <br />
          ...
          <li>
            <strong>Transit Data (San Joaquins)</strong>
            <br />
          ...
          <li>
            ...
            <br />
            <span className="text-gray-500">Sacramento light rail. 3 lines, 55 stations.</span>
          </li>
          <li>
