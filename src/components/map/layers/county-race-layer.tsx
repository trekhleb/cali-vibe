...
const FILL_LAYER_ID = "county-race-fill";
...
export type RaceMetric = "white" | "hispanic" | "black" | "asian" | "other";

export const RACE_LABELS: Record<RaceMetric, string> = {
  white: "White (non-Hispanic)",
  hispanic: "Hispanic or Latino",
  black: "Black or African American",
  asian: "Asian",
  other: "Other / Two or More Races",
};
...
interface CountyRaceLayerProps {
...
export default function CountyRaceLayer({ raceMetric, overlayOffset = 0, selectName = null, onToggleFavorite, isFavorite }: CountyRaceLayerProps) {
  ...
  const highlightLineLayer: LineLayerSpecification = {
    id: "county-race-borders-highlight",
    type: "line",
    source: SOURCE_ID,
    paint: {
  ...
  return (
    <>
      ...
      <Source id={LABEL_SOURCE_ID} type="geojson" data={LABELS_URL}>
        <Layer {...labelLayer} id="county-race-labels-dim" filter={labelDimFilter} />
        <Layer
          {...labelLayer}
          id="county-race-labels-highlight"
