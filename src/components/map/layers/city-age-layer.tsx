...
import {
  AGE_LABELS,
  type AgeMetric,
} from "./county-age-layer";

const SOURCE_ID = "cities-age";
const LABEL_SOURCE_ID = "city-age-labels-source";
const FILL_LAYER_ID = "city-age-fill";
...
export function CityAgeLegend({ ageMetric, overlayOffset = 0 }: { ageMetric: AgeMetric; overlayOffset?: number }) {
  ...
  return (
    <>
      ...
      <Source id={LABEL_SOURCE_ID} type="geojson" data={LABELS_URL}>
        <Layer {...labelLayer} id="city-age-labels-dim" filter={labelDimFilter} />
        <Layer
          {...labelLayer}
          id="city-age-labels-highlight"
