...
export default function CityEducationLayer({ educationMetric, overlayOffset = 0, selectName = null, onToggleFavorite, onViewDetail, isFavorite }: CityEducationLayerProps) {
