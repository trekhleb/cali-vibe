...
const FILL_LAYER_ID = "county-poverty-fill";
...
export const POVERTY_LABEL = "Poverty Rate";
...
interface CountyPovertyLayerProps {
  overlayOffset?: number;
  selectName?: string | null;
}

export function PovertyLegend({ overlayOffset = 0 }: { overlayOffset?: number }) {
  return (
    <div
...
export default function CountyPovertyLayer({ overlayOffset = 0, selectName = null }: CountyPovertyLayerProps) {
  ...
  const highlightLineLayer: LineLayerSpecification = {
    id: "county-poverty-borders-highlight",
    type: "line",
    source: SOURCE_ID,
    paint: {
  ...
  return (
    <>
      ...
      <Source id={LABEL_SOURCE_ID} type="geojson" data={LABELS_URL}>
        <Layer {...labelLayer} id="county-poverty-labels-dim" filter={labelDimFilter} />
        <Layer
          {...labelLayer}
          id="county-poverty-labels-highlight"
